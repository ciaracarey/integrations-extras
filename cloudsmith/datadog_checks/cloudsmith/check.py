...
class CloudsmithCheck(AgentCheck):
    ...
    def check(self, instance):
        ...
        if 'vulnerability_at_least_high_count' in vulnerability_info:
            vulnerability_at_least_high_count = vulnerability_info['vulnerability_at_least_high_count']
        if 'total_vulnerabilities' in vulnerability_info:
            total_vulnerabilities = vulnerability_info['total_vulnerabilities']
        if 'package_count' in vulnerability_info:
            package_count = vulnerability_info['package_count']
        ...
        self.gauge("cloudsmith.vulnerability_at_least_high_count", vulnerability_at_least_high_count, tags=self.tags)
        self.gauge("cloudsmith.total_vulnerabilities", total_vulnerabilities, tags=self.tags)
        self.gauge("cloudsmith.package_count", package_count, tags=self.tags)
